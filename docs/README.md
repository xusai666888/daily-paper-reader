...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-08 22:54:46 UTC<br>状态：成功</p>
</section>
...
<p>精读：《CrossFeat: Bridging Imaging Modalities in Feature Descriptor Space》（8.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="CrossFeat: Bridging Imaging Modalities in Feature Descriptor Space">CrossFeat: Bridging Imaging Modalities in Feature Descriptor Space</span></li></ul>
  </div>
