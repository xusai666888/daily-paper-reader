...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-11 22:12:24 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Prototype Matters: Modality-unified Prototype Self-distillation for Unsupervised Visible-infrared Person Re-identification》（10.0/10）, 《MMGait: Benchmarking and Unifying Gait Recognition across Heterogeneous Modalities》（8.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Prototype Matters: Modality-unified Prototype Self-distillation for Unsupervised Visible-infrared Person Re-identification">Prototype Matters: Modality-unified Prototype Self-distillation for Unsupervised Visible-infrared Person Re-identification</span></li><li><span class="dpr-home-dashboard-paper-title" title="MMGait: Benchmarking and Unifying Gait Recognition across Heterogeneous Modalities">MMGait: Benchmarking and Unifying Gait Recognition across Heterogeneous Modalities</span></li></ul>
  </div>
